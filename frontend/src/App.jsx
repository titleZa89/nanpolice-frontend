...
function HomePage() {
  ...
  <div style={{ 
    ...
    <iframe 
      ...
      src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fpolice5.nan&tabs=timeline&height=1500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=" 
      style={{ 
        border: 'none', 
        width: '100%', 
        height: '1500px' // ปรับความสูงให้พอดี ไม่ต้องยาวเกินไปจนดูแปลก
      }} 
